...
from level_dicts import hierarchy
from helper import read_meta, csv_to_list_coarselabels, csv_to_list_finelabels
...
class LoadDataset(Dataset):
    ...
    def __init__(self, csv_path, cifar_metafile, image_size=100, image_depth=3, return_label=True, transform=None):
        '''Init param.
        '''
        ...
        self.coarse_labels = csv_to_list_coarselabels()
        self.fine_labels = csv_to_list_finelabels()
