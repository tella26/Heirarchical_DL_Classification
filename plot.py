...
def plot_loss_acc(path, num_epoch, train_accuracies_superclass, train_accuracies_subclass, train_losses,
    ...
    train_superclass_accuracy_df = train_superclass_accuracy_df.reset_index(drop=True, inplace=True)
    train_subclass_accuracy_df = train_subclass_accuracy_df.reset_index(drop=True, inplace=True)
    test_superclass_accuracy_df = test_superclass_accuracy_df.reset_index(drop=True, inplace=True)
    test_subclass_accuracy_df = test_subclass_accuracy_df.reset_index(drop=True, inplace=True)
    ...
    train_loss_df = train_loss_df.reset_index(drop=True, inplace=True)
    test_loss_df = test_loss_df.reset_index(drop=True, inplace=True)
